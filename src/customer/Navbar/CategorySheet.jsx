...
const CategorySheet = ({ selectedCategory, setShowSheet }) => {
  ...
  return (
    <Box className="bg-white shadow-lg lg:h-[500px] overflow-auto">
      <div className="flex flex-wrap text-sm">
        {categoryTwo[selectedCategory]?.map((item, index) => (
          <div
            key={item.categoryId}
            className={`p-6 lg:w-[20%] ${
              index % 2 === 0 ? "bg-slate-50" : "bg-white"
            }`}
          >
            <p className="text-[#00927c] mb-4 font-semibold">
              {item.name}
            </p>
              ...
              {childCategory(
                ...
                <li
                  ...
                  onClick={() => {
                    ...
                    setShowSheet(false); // 👈 close sheet
                  }}
