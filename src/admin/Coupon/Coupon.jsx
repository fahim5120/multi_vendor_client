...
import { deleteCoupon, fetchAllCoupons,  } from "../../Redux Toolkit/features/admin/CouponSlice";
...
export default function Coupon() {
  const dispatch = useAppDispatch();
  const couponState = useAppSelector((store) => store.adminCoupon);
